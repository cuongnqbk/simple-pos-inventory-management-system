...
<div class="app-title">
    <div>
        <h1><strong><i class="fab fa-angellist"></i> Add Client</strong></h1>
    </div>
        ...
        <div class="col">
            <div class="card border-dark">
                <div class="card-header bg-dark">
                    <h2 class="text-white">Add Client</h2>
                </div>
                <div class="card-body">
                    <form action="{{ route('client.store') }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" class="datepicker form-control{{ $errors->has('business_started_since') ? ' is-invalid' : '' }}" name="business_started_since" id="business_started_since" value="">
                                @if ($errors->has('business_started_since'))
                                    <span class="invalid-feedback">
                                        <strong>{{ $errors->first('business_started_since') }}</strong>
                                    </span>
                                @endif
                            </div>
                            <div class="col-md-4 form-group">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" class="form-control{{ $errors->has('reference') ? ' is-invalid' : '' }}" name="reference" id="reference" value="">
                            ...
                            <div class="col-md-6 form-group">
                                <label>Address</label>
                                <textarea type="text" class="form-control{{ $errors->has('address') ? ' is-invalid' : '' }}" name="address" id="address" value=""></textarea>
